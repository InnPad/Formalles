...
using Formall.Imaging.QrCode.Encoding.DataEncodation.InputRecognition;
...
using Formall.Imaging.QrCode.Encoding.Versions;
using Microsoft.VisualStudio.TestTools.UnitTesting;
using GMode = Formall.Imaging.QrCode.Encoding.DataEncodation.Mode;
using Mode = com.google.zxing.qrcode.decoder.Mode;

namespace Formall.Imaging.QrCode.Encoding.Tests.PerformanceTest
{
