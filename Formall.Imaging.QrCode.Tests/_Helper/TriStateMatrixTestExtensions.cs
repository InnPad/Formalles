...
using TriStateMatrixToGraphicExtensions = Formall.Imaging.QrCode.Encoding.Tests.TriStateMatrixToGraphicExtensions;

namespace Formall.Imaging.QrCode.Encoding.Tests
{
