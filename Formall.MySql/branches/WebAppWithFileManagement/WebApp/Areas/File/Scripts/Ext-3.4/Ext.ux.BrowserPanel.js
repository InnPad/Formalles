...
*/
Ext.ux.BrowserPanel = Ext.extend(Ext.Panel, {
    
    // Panel that displays files
    files: new Ext.ux.FilePanel(),
    
    // create the panel that displays folders
    folders: new Ext.ux.FolderTree({
    }),
    ...
    */
    initComponent: function () {
        ...
        // create the panel that displays folders
        this.folders.selectionChange = Ext.createDelegate(this.onFolderSelectionChange, this, "");
    ...
    * @returns	{Void}
    */
    onFolderSelectionChange: function (path) {
        this.files.setPath(path);
    }, // eo function onFolderSelectionChange
    ...
    * @returns	{Void}
    */
    onFileSelectionChange: function (sm) {
        if (sm.hasSelection()) {
            //this.enableGridToolbarButtons();
        } else {
            //this.disableGridToolbarButtons();
        }
    }, // eo function onFileSelectionChange
