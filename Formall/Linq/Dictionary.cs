...
namespace Formall.Linq
{
    ...
    public class Dictionary : IDictionary
    {
        ...
        {
            var field = Model.Fields.Values.AsQueryable<Field>().FirstOrDefault(o => o.Name == name) ?? Model.Fields.Values.AsQueryable<Field>().FirstOrDefault(o => string.Equals(o.Name, name, StringComparison.OrdinalIgnoreCase));
        ...
        private class MetaObject : System.Dynamic.DynamicMetaObject
        {
            ...
            public override DynamicMetaObject BindInvokeMember(InvokeMemberBinder binder, DynamicMetaObject[] args)
            {
                ...
                DynamicMetaObject methodInfo = new DynamicMetaObject(
                    Expression.Call(
                    Expression.Convert(Expression, LimitType),
                    typeof(DynamicObject).GetMethod("WriteMethodInfo"),
                    parameters),
                    BindingRestrictions.GetTypeRestriction(Expression, LimitType));
                return methodInfo;
            }
            ...
            public override DynamicMetaObject BindSetMember(SetMemberBinder binder, DynamicMetaObject value)
            {
                ...
                var methodCall = Expression.Call(self, typeof(DynamicObject).GetMethod(methodName), args);
