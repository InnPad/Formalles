...
namespace Formall.Presentation
{
    public class MediaType
    {
        ...
        private MediaType(string name, string description = null)
        {
            _name = name;
        }
        ...
        public static implicit operator MediaType(string name)
        {
            ...
            if (!_dictionary.TryGetValue(name, out mt))
            {
                mt = _dictionary.AddOrUpdate(name, new MediaType(name), (key, value) => { return value; });
            }
